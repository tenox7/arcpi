...
# loader.bin is for real-hardware SD boot (firmware loads it at the native 0x8000).
...
exec qemu-system-arm -M raspi2b -m 1G -kernel "$ROOT/obj/loader.elf" -serial mon:stdio
